                ...
                <div className="container scheduling-container">
                    <div className="scheduling-details">
                        ...
                        <div className="scheduling-details-info">
                            ...
                            <p className="scheduling-text-description">{content.localConsulta.logradouro}, {content.localConsulta.numero}, {content.localConsulta.bairro}, {content.localConsulta.cidade} {content.localConsulta.estado}</p>
                        </div>
                        <div className="divider"></div>
                        <div className="scheduling-details-info">
